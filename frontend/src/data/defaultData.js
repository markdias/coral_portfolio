...
export const defaultData = {
  settings: {
    adminPassword: 'atelier2024'
  },
  home: {
    eyebrow: 'Surface pattern atelier',
    title: 'Tailored fashion prints distilled from tidal botanica',
    description:
      'Coral Atelier is the print practice of Isla Marin, blending hand-painted botanicals, underwater photography, and experimental dye labs into couture-ready surfaces. Each commission braids ocean narratives with tactile color stories for runway, resort, and editorial collaborators.',
    primaryCta: {
  ...
  projects: [
    {
      ...
      metadata: buildMetadata([
        { label: 'Client', value: 'Luna Atelier' },
